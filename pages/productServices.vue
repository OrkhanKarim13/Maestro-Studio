<template>
    <section class="mx-9 mb-6 bg-[#0047FF]  rounded-md">
        <div class="p-12 flex w-full flex-col items-start justify-center gap-6">
            <div class="w-full "><img class="object-cover w-full h-[600px]" src="../assets/images/Frame2(2).svg" alt="">
            </div>
            <h2 class="text-8xl text-white leading-snug">Enterprise Software
                Development</h2>
            <p class="text-white text-3xl leading-10">Transform your business with custom software to meet the challenges of
                today and tomorrow. Take full advantage of our more than 8 years of hands-on experience in enterprise
